            ...
            <div className="flex items-center w-full justify-between">
              <span className="self-start text-xs">
                ...
                <span className="font-bold">
                  {isLoading ? "..." : (totalUsed / 1024) > 1000 ? (totalUsed / 1024).toFixed(2).charAt(0) + " GB" : (totalUsed / 1024) + " MB"}
                </span>
              </span>
              <span className="self-end text-xs">
                Max.{" "}
                <span className="font-bold">
                {(totalLimit / 1024) > 1000 ? (totalLimit / 1024).toFixed(2).charAt(0) + " GB" : (totalLimit / 1024) + " MB"}
                </span>
              </span>
            </div>
          </div>
