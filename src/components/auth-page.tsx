          ...
          <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
            <div className="flex flex-col gap-3">
              <Link href="/" className="mr-4 flex items-center gap-2 lg:mr-6">
                <Icons.logoFull className="h-auto w-44 mb-2" />
              ...
              <div className="mt-4 md:mb-12 max-w-2xl">
                <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                  Leve seus PDFs para a nuvem e incorpore em qualquer lugar com
                  facilidade.
                </h1>
                <p className="text-xl text-muted-foreground">
                  A solução definitiva para empresas que precisam compartilhar
                  documentos de forma profissional e sem complicações.
                </p>
              </div>
              {/* End Title */}
              {/* Blockquote */}
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic">
                    Simples, rápido e confiável. Nossa equipe agora gerencia
                    documentos de forma eficiente e sem dores de cabeça.
                  </p>
                </div>
                <footer className="mt-3">
                  <div className="flex items-center">
                    ...
                    <div className="grow ms-4">
                      <div className="font-semibold">Sophie J. Amber</div>
                      <div className="text-xs text-muted-foreground">
                        CTO | Speedtalk Technologies
                      </div>
                    </div>
                  </div>
                </footer>
